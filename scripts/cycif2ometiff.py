...
cycif_pattern=re.compile("^Registered-R([0-9]+)_([a-zA-Z0-9-]+)\.([a-zA-Z0-9-]+)\.([a-zA-Z0-9-]+)\.([a-zA-Z0-9-]+)_([a-zA-Z0-9-]+)-Scene-([0-9]+).*_c([0-9])_*")
...
if exps_avail:
    ...
    for i in range(0, int(chan_count)):
        part4 += "         <Plane ExposureTime=\"" + str(exposures[i]) + "\" ExposureTimeUnit=\"ms\" TheC=\"" + str(i) + "\" TheT=\"0\" TheZ=\"0\"/>\n"
else:
    part4 = "         <TiffData/>"
